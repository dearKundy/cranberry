package com.kundy.justbattle.redisproblem;
...
public class DbCacheDoubleWriteConsistency {
     ...
     * 4. 线程A 更新了缓存
     */
    public boolean updateWithBugVersionOne(JbGoodsPo goodsPo, Integer sleepTime) {
     ...
     * 5. 线程A 将新值写入数据库
     */
    public boolean updateWithBugVersionTwo(JbGoodsPo goodsPo, Integer sleepTime) {
     ...
     * 5. 请求A将查到的旧值写入缓存
     */
    public boolean updateWayThree(JbGoodsPo goodsPo) {
